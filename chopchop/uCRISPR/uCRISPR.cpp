...
std::string getexepath()
{
   ...
   return res.substr(0, res.size()-7); // minus uCRISPR (7 letters)
}

string DIR=getexepath();
string DATA=DIR+"/data/"; //absolute path
string RNAstructure=DIR+"EnsembleEnergy"; //PUT HERE FULL PATH TO THIS PROGRAM
...
double GetSgRNAEnergy(string sequence) {
   ...
   // this will add path to the data_tables for EnsembleEnergy
   string env_path=DIR+"/RNAstructure_data_tables/";
